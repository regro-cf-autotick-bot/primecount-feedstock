...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/primecount-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/primecount-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install primecount
```
...
It is possible to list all of the versions of `primecount` available on your platform:
...
```
pixi search primecount --channel conda-forge
```
